 local Vim do   local _class_0   local _base_0 = {     eval = function(vimL)
      ...
      return vim.api.nvim_call_function(functionName, args)     end   }   _base_0.__index = _base_0   _class_0 = setmetatable({     __init = function() end,     __base = _base_0,     __name = "Vim"   }, {     __index = _base_0,     __call = function(cls, ...)       local _self_0 = setmetatable({}, _base_0)       cls.__init(_self_0, ...)       return _self_0     end   })   _base_0.__class = _class_0   Vim = _class_0 end
...
local Assert Assert = function(condition, message)
  if not condition then
    if message then
      ...
      return error("Assert hit!")     end   end end local Path do   local _class_0   local _base_0 = {     join = function(left, right)
      ...
      return path:match('^(.*)[\\/][^\\/]*$')     end   }   _base_0.__index = _base_0   _class_0 = setmetatable({     __init = function() end,     __base = _base_0,     __name = "Path"   }, {     __index = _base_0,     __call = function(cls, ...)       local _self_0 = setmetatable({}, _base_0)       cls.__init(_self_0, ...)       return _self_0     end   })   _base_0.__class = _class_0   Path = _class_0 end local File do   local _class_0   local _base_0 = {     exists = function(path)
      ...
      return Vim.callFunction('delete', {         path       })     end   }   _base_0.__index = _base_0   _class_0 = setmetatable({     __init = function() end,     __base = _base_0,     __name = "File"   }, {     __index = _base_0,     __call = function(cls, ...)       local _self_0 = setmetatable({}, _base_0)       cls.__init(_self_0, ...)       return _self_0     end   })   _base_0.__class = _class_0   File = _class_0 end local Directory do   local _class_0   local _base_0 = {     getAllFilesWithExtensionRecursive = function(path, extension)       local _accum_0 = { }       local _len_0 = 1



      local _list_0 = Vim.callFunction('globpath', {         path,         "**/*." .. tostring(extension),         0,         1       })       for _index_0 = 1, #_list_0 do         local x = _list_0[_index_0]         _accum_0[_len_0] = Path.normalize(x)         _len_0 = _len_0 + 1       end       return _accum_0     end   }   _base_0.__index = _base_0   _class_0 = setmetatable({     __init = function() end,     __base = _base_0,     __name = "Directory"   }, {     __index = _base_0,     __call = function(cls, ...)       local _self_0 = setmetatable({}, _base_0)       cls.__init(_self_0, ...)       return _self_0     end   })   _base_0.__class = _class_0   Directory = _class_0 end
...
local timeStampIsGreater timeStampIsGreater = function(file1Path, file2Path)
  ...
  return time1 > time2 end local MoonMaker do   local _class_0   local _base_0 = {     executeMoon = function(moonText)



      local luaText = Vim.callFunction("system", {         "moonc --",         moonText       })
      return loadstring(luaText)()     end,     compileMoonIfOutOfDate = function(moonPath, luaPath)
      ...
      return numUpdated     end   }   _base_0.__index = _base_0   _class_0 = setmetatable({     __init = function() end,     __base = _base_0,     __name = "MoonMaker"   }, {     __index = _base_0,     __call = function(cls, ...)       local _self_0 = setmetatable({}, _base_0)       cls.__init(_self_0, ...)       return _self_0     end   })   _base_0.__class = _class_0   MoonMaker = _class_0   return _class_0 end
